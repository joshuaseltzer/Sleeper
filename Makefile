...
TWEAK_NAME = Sleeper
Sleeper_FILES = SLCompatibilityHelper.m SLPrefsManager.m SLAlarmPrefs.m SLPickerTableViewController.m SLSkipTimeViewController.m SLSnoozeTimeViewController.m SLSkipAlarmAlertItem.xm SLAlarmManager.x SLEditAlarmViewController.x SLSBApplication.x SLUNLocalNotificationClient.x SLSBClockDataProvider.x SLSBLockScreenViewController.x SLUNSNotificationSchedulingService.x SLSBLockScreenManager.x
