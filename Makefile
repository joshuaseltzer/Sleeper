...
TWEAK_NAME = Sleeper
$(TWEAK_NAME)_FILES = iOS13/SLSBDashBoardLockScreenEnvironment.x iOS10/SLMTSleepAlarmOptionsController.x iOS10/SLMTSleepAlarmViewController.x \
iOS10/SLSBLockScreenManager.x iOS9/SLUNLocalNotificationClient.x iOS8/SLSBApplication.x common/SLMTAlarmManager.x \
