...
common/SLMTAlarmManager.x common/SLMTAlarmStorage.x common/SLMTUserNotificationCenter.x common/SLAlarmManager.x common/SLEditAlarmViewController.x \
common/SLMTAAlarmEditViewController.x common/SLMTABedtimeOptionsViewController.x common/SLMTABedtimeViewController.x common/SLSBClockDataProvider.x \
...
THEOS_PACKAGE_BASE_VERSION = 6.0.0
_THEOS_INTERNAL_PACKAGE_VERSION = 6.0.0
