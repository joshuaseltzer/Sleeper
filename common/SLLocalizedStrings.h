...
#define kSLAutoSetOnWithOffsetExplanationString(numHours, numMinutes, offsetType, sunType)  [NSString stringWithFormat:[kSLSleeperBundle localizedStringForKey:@"AUTO_SET_ON_WITH_OFFSET_EXPLANATION" value:@"This alarm's fire time will automatically be set to %@ and %@ %@ %@." table:@"Localizable"], numHours, numMinutes, offsetType, sunType]
