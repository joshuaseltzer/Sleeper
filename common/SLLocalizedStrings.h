...
#define kSLAutoSetOnExplanationString(sunType)                                          [NSString stringWithFormat:[kSLSleeperBundle localizedStringForKey:@"AUTO_SET_ON_EXPLANATION" value:@"This alarm's fire time will be automatically set to the %@." table:@"Localizable"], sunType]
#define kSLAutoSetOnWithOffsetExplanationString(hours, minutes, offsetType, sunType)    [NSString stringWithFormat:[kSLSleeperBundle localizedStringForKey:@"AUTO_SET_ON_WITH_OFFSET_EXPLANATION" value:@"This alarm's fire time will be automatically set to %ld hour(s) and %ld minute(s) %@ the %@." table:@"Localizable"], hours, minutes, offsetType, sunType]
